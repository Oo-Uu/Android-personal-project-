...
public class B1WriteActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_b1_write);
        hideActionBar();
    ...
    public void onClick(View v) {
        if (mAuth.getCurrentUser() != null) {
            String postId= mStore.collection(FirebaseId.board1).document().getId();
            ...
            mStore.collection(FirebaseId.board1).document(postId).set(data, SetOptions.merge());
            finish();
        }
