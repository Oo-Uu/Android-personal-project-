...
public class Board_Ruo extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_board__ruo);
        hideActionBar();
    ...
    protected void onStart() {
        ...
        mStore.collection(FirebaseId.board1)
    ...
    public void onClick(View v) {
        Intent intent2=new Intent(this,B1WriteActivity.class);
