...
public class Board_Mat extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_board__mat);
        hideActionBar();
    ...
    protected void onStart() {
        ...
        mStore.collection(FirebaseId.board2)
    ...
    public void onClick(View v) {
        Intent intent2=new Intent(this,B2WriteActivity.class);
